  ...
  asyncHandler(async (req, res) => {
    ...
    const packageData = {
      ...
      included_services: package.included_services
        ? JSON.parse(package.included_services)
        : [],
      excluded_services: package.excluded_services
        ? JSON.parse(package.excluded_services)
        : [],
      itinerary: package.itinerary ? JSON.parse(package.itinerary) : {},
      requirements: package.requirements
        ? JSON.parse(package.requirements)
        : [],
      recommendations: package.recommendations
        ? JSON.parse(package.recommendations)
        : [],
      hotel_amenities: package.hotel_amenities
        ? JSON.parse(package.hotel_amenities)
        : [],
      seasonal_pricing: package.seasonal_pricing
        ? JSON.parse(package.seasonal_pricing)
        : {},
      availability_calendar: package.availability_calendar
        ? JSON.parse(package.availability_calendar)
        : {},
      gallery_images: package.gallery_images
        ? JSON.parse(package.gallery_images)
        : [],
      gallery_videos: package.gallery_videos
        ? JSON.parse(package.gallery_videos)
        : [],
